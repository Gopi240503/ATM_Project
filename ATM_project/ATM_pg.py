...
def bank():
    ...
    if account in accno:
        ...
        bank = {"0092":1000,"27833":0,"78364":0}
...
lbl3 = Label(f1,font=('aria',16,'bold'),text="Enter the account number", fg ="Powder Blue" , bg="black", bd=10,anchor='w')
lbl3.grid(row=0,column=3)
text = Entry(f1,font=('ariel',16,'bold'),bg ="Powder Blue", bd=6, insertwidth=4,textvariable=number, justify='right')
